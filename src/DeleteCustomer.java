...
public class DeleteCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(20, 140, 205, 37);
        ...
        jTextField1.setBounds(231, 133, 268, 41);
        ...
        jButton1.setBounds(144, 239, 239, 55);

        jLabel2.setFont(new java.awt.Font("Lucida Calligraphy", 1, 35)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Delete Customer");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(110, 40, 336, 49);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stockp.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String quary1="Select * from customerregister where Customer='"+Cname+"'";
                    
                 ResultSet rs=db.executeQuery(quary1);
                 if(rs.next())
                 {
                     String Customer=rs.getString("Customer");
                     String query2="Delete from Customerregister where Customer='"+Cname+"'";
                     db.executeUpdate(query2);
                     JOptionPane.showMessageDialog(this, "DeleteSuccess");
                 }
                 else{
                     JOptionPane.showMessageDialog(this,"Customer name not found in DB");
                 }
